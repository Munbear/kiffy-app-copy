...
@freezed
class UserProfileCreateAndEditCommanProfileContact
    with _$UserProfileCreateAndEditCommanProfileContact {
  factory UserProfileCreateAndEditCommanProfileContact({
    required String contactId,
    required ContactType contactType,
  }) = _UserProfileCreateAndEditCommanProfileContact;

  factory UserProfileCreateAndEditCommanProfileContact.fromJson(
