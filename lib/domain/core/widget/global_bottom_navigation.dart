...
class GlobalBottomNavigation extends HookConsumerWidget {
  GlobalBottomNavigation({super.key});
        ...
        children: items.value
            .map(
              (paths) => GlobalBottomNavigationItem(
                props: GlobalBottomNavigationItemProps(
                    iconPath: paths.iconPath, routePath: paths.routePath, curRoutePath: curRoute.location),
              ),
            )
            .toList(),
      ),
