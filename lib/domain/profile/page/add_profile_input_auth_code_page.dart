...
class AddProfileInputAuthCodePage extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _AddProfileInputAuthCodePageState();
}

class _AddProfileInputAuthCodePageState
    extends ConsumerState<AddProfileInputAuthCodePage> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: const TextSpan(
                  children: [
                    TextSpan(
                      text:
                          "Please enter 6 digits of the number sent by text.\nex. ",
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 13,
              ...
              TextFormField(
                decoration:
                    const InputDecoration(hintText: "six digits of a number"),
              ),
              const Spacer(),
              MainBlueButton(
                text: "Certification",
