...
//   final profileUpload = await ApiClient().dio.put("/product/api/view/user/v1/my/profile", data: requests);
//   return UserProfileUpload.fromJson(profileUpload.data);
// }

// Future<UserProfileUpload> getTest() async {
//   final res = await ApiClient().dio.get("/product/api/view/user/v1/my/profile");
